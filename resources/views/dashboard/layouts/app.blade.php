...
{{--    </div>--}}
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
            <div class="sidebar-brand brand-logo" href="{{ route('home') }}" style="color: white">Dashboard</div>
...
{{--                </ul>--}}
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    {{--                            <a class="dropdown-item preview-item">--}}
                    {{--                                <div class="preview-thumbnail">--}}
                    {{--                                    <img src="{{ asset('template/assets/images/faces/face2.jpg') }} " class="rounded-circle profile-pic">--}}
                    {{--                                </div>--}}
                    {{--                                <div class="preview-item-content">--}}
                    ...
                    {{--                            <a class="dropdown-item preview-item">--}}
                    {{--                                <div class="preview-thumbnail">--}}
                    {{--                                    <img src="{{ asset('template/assets/images/faces/face3.jpg')}}"  class="rounded-circle profile-pic">--}}
                    {{--                                </div>--}}
                    {{--                                <div class="preview-item-content">--}}
...
{{--                                                        </a>--}}
                                                        <div class="dropdown-divider"></div>
                            <a class="dropdown-item preview-item" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" href="{{ route('logout') }}">
...
{{--                                                        <p class="p-3 mb-0 text-center">Advanced settings</p>--}}
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                {{--                                        <img src="{{ asset('template/assets/images/dashboard/Group126@2x.png')}}" class="gradient-corona-img img-fluid" alt="">--}}
                {{--                                    </div>--}}
